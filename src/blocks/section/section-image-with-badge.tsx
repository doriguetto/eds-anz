...
export default ({innerSections}: SectionData) => {
    ...
    if (innerSections) {
        ...
        const badge = innerSections && innerSections[1].querySelector('picture')
        if (badge) {
            const imgData = {
                pictureEl: badge,
                preload: true,
        ...
        badgeSectionContent = innerSections && innerSections[2]
        button = innerSections && innerSections[3].querySelector('a')
    }
                                ...
                                <div className="container__item container__aside__element     none">
                                    <div className="box--top">
                                        <div className="text parbase">
                                            ...
                                            {button &&
                                                <div className="btn btn--blue btn--transparent badge-button"
                                                   aria-label="Learn about financial wellbeing"
